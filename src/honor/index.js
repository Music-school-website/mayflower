                                    ...
                                    <div className="row mx-m-25">
                                            ...
                                            <div className="blog-post-content">
                                                ...
                                                <div className="blog-post-content-wrap">
                                                    <header className="entry-header">
                                                        <h2 className="entry-title"><a href="#">Good News: Won prizes in Vienna, Austria </a></h2>
                                                        <div className="entry-meta flex align-items-center">
                                                            <div className="post-author"><a href="#">Zhao Tianyi, Wen Ziyang and other 6 students</a></div>
                                                        </div>{/* .entry-meta */}
                                                    </header>{/* .entry-header */}
                                        ...
                                        <div className="col-12 col-md-6 px-25">
                                            <div className="blog-post-content">
                                                ...
                                                <div className="blog-post-content-wrap">
                                                    <header className="entry-header">
                                                        <h2 className="entry-title"><a href="#">Won the prize in the Franz Schubert in Austria</a></h2>
                                                        <div className="entry-meta flex align-items-center">
                                                            <div className="post-author"><a href="#">Wang Yihan, Zhao Yiru </a></div>
